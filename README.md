...
We re-implement the paper with Pytorch 1.9.1+cu111 on 2 NVIDIA A40 GPUs, and our trained model weights (EfficientNet B0 as backbone) are provided concomitantly. These models are trained using our private mammogram database (about 67,000 mammographic images). 
